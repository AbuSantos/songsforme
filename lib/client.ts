...
export const contractABI = [
  ...
  {
    inputs: [],
    name: "ListenerRewardMustBeGreaterThanZero",
    type: "error",
  },
  {
    anonymous: false,
...
// Initialize the contract for thirdweb
...
export const nftFactoryContractABI = [
  {
    anonymous: false,
    inputs: [
      {
...
export const nftContract = async (contract: string) => {
  return getContract({
    client,
    chain,
    address: contract,

                            ...
                            <div className="mt-auto w-full fixed bottom-0  md:hidden h-20">
                                <TabsList className="w-full py-5 h-20  rounded-none bg-black">
                                    <div className=" w-full py-4 flex justify-between">
                                        ...
                                        <TabsTrigger value="podcasts" className="relative flex space-y-2  data-[state=active]:bg-">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="25" height="25" color="#000000" fill="none" className="hidden">

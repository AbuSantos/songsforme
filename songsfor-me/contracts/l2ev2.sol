...
contract BullchordMarketPlaceListen is ReentrancyGuard {
   ...
   //LISTEN TO EARN EVENTS
    ...
    constructor(uint256 _platformFee, address _token, uint256 _initialRate, 
    ...
    modifier isOwner(
        ...
        require(token.transfer(listener, amountReward), "Listener reward transfer failed");

        emit RewardsDistributed(listener, address(0), amountReward, 0);  
    }

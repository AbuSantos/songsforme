...
export const Copy = ({ address, mode }: { address: string | "", mode?: string }) => {
    ...
    return (
        <Button className='bg-transparent border-none shadow-none hover:bg-purple-400 py-0 px-1 text-gray-300 md:block hidden' onClick={handleCopy} aria-label='Copy Address'>

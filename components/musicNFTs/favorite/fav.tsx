...
export const Favorite = ({ userId, nftId }: FavTypes) => {
    ...
    return (
        <div>
            <Button className='bg-[var(--button-bg)] shadow-md md:hidden' onClick={handleFav} >
                {
                    !added ?
                        <span className='flex items-center space-x-2 text-[1rem] capitalize' >
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style={{ fill: "#EDEEF0", transform: "msFilter" }}
                                className='mr-2'
            ...
            <Button className='bg-[var(--button-bg)] shadow-md hidden md:block' onClick={handleFav}
            >
                {
                    !added ?

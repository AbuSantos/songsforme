...
export const Playlistenn = ({ userId, nftId, playlistId, nftContractAddress, tokenId }: PlaylistIdTypes) => {
        ...
        <div>
            {
                ...
                <Button onClick={handlePlayPause} disabled={isLoading} className='bg-[var(--button-bg)] shadow-md'>
                    {isLoading ?
                        ...
                        : isPlaying ?
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#EDEEF0" className="size-6">
